...
public class Summarizer {
	...
	private Map<String, Integer> getWordCounts(String text)
	{
		...
		public static void main(String[] args) {
			...
			Map<String , Integer> map = s.getWordCounts("I am trying to print out all the elements of a List, however it is printing the pointer of the Object rather than the value.");
			/*map =s.getWordCounts("sit");
			map= s.getWordCounts("Hello");
			map = s.getWordCounts("Hello");
			*/
			...
			List<String> l = s.sortByFreqThenDropFreq(map);
			for(String E: l){
